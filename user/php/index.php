...
<body>
        ...
        <form>
            <div class="w3-row">
                <div class="w3-center" style="padding-right:4px">
                    ...
                    <button class="w3-button w3-teal w3-round w3-right" type="submit" name="submit" value="search">search</button>
                </div>
    ...
    <div class="w3-grid-template">
        ...
        foreach ($rows as $courses) {
            ...
            echo "<a href = 'subjectdetails.php?prid=$prid' style ='text-decoration: none;'><div class ='w3-center w3-padding'>";
